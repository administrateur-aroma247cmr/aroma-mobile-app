...
class InterventionCreateScreen extends StatefulWidget {
  const InterventionCreateScreen({super.key});

  @override
  State<InterventionCreateScreen> createState() =>
      _InterventionCreateScreenState();
}

class _InterventionCreateScreenState extends State<InterventionCreateScreen> {
        ...
        _FormSection(
          ...
          children: [
            ...
            _DateField(
              ...
              value: _dateIntervention != null
                  ? _fmtDate(_dateIntervention!)
                  : 'Choisir une date (optionnel)',
              hasValue: _dateIntervention != null,
              onTap: _pickDate,
              onClear: _dateIntervention != null
                  ? () => setState(() => _dateIntervention = null)
                  : null,
            ),
            const SizedBox(height: 14),
            _ModernTextField(
          ...
          const Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                  'Client ou prospect, type, technicien et date',
                  style: TextStyle(
